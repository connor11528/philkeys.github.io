...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsLayout = __webpack_require__(17);
      ...
      value: function render() {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement('p', { className: 'Content-summary' }),
            _react2['default'].createElement(
              'a',
              { href: '/advantage', onClick: Link.handleClick },
              'Take a look'
            )
          )
        );
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Img = __webpack_require__(7).Image;
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              'By trusting your gut instincts, experience new tastes around the neighborhood, in a simple and fun way'
            ),
            _react2['default'].createElement(
              'a',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _HeroListHeroList = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsIndexHeroHero = __webpack_require__(14);

  var _componentsIndexHeroHero2 = _interopRequireDefault(_componentsIndexHeroHero);

  var _componentsIndexUpUpUpUp = __webpack_require__(16);

  var _componentsIndexUpUpUpUp2 = _interopRequireDefault(_componentsIndexUpUpUpUp);

  var _componentsIndexFeaturesFeatures = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "/**\n * React Static Boilerplate\n * https://github.com/koistya/react-static-boilerplate\n * Copyright (c) Konstantin Tarkus (@koistya) | MIT license\n */\n\n/*\n * Scaffolding\n * -------------------------------------------------------------------------- */\n\n/* Colors */\n\n/* Uses */\n\n\n/*\n * Typography\n * -------------------------------------------------------------------------- */\n\n\n/*\n * Media queries breakpoints\n * -------------------------------------------------------------------------- */\n\n/* Old Media Queries\n$iphone5-screen: 320px;\n$iphone6-screen: 375px;\n$tiny-screen: 500px;\n$extra-small-screen: 600px;\n$small-screen: 768px;\n$small-medium: 940px;\n$medium-screen: 1280px;\n$large-screen: 1440px;\n$x-large-screen: 1600px;\n*/\n\n/* React-starter-kit\n$screen-sm-min: 768px;\n$screen-md-min: 992px;\n$screen-lg-min: 1200px;\n*/\n\n/* Supported Size Ranges: */\n/* handhelds, except-handhelds */\n/* small-screens, except-small-screens, to-small-screens, above-small-screens */\n/* medium-screens, except-medium-screens, above-medium-screens */\n/* large-screens, except-large-screens */\n/* Use: */\n/* @include media(handhelds, large-screens) */\n/* @include media(above-small-screens) {\n     max-width: 960px\n   }\n*/\n\n/* Typesetting variables. Edit these! */ /* in pixels. This would result in 22px on desktop */ /* how large the line height is as a multiple of font size */ /* ADJUST THE FIRST IF YOU CHANGE $baselineHeight\n\n/* Rate of growth for headings */\n/* I actually like this to be slightly smaller then the leading. Makes for tight headings. */\n\n/* Setup */\nhtml {\n  /* Change default typefaces here */\n  font-family: 'ProximaNova-Regular', 'Open Sans', 'Helvetica', 'sans-serif';\n  font-size: calc(22 / 16 * 100%);\n  font-weight: normal;\n  font-style: normal;\n  color: #394453;\n\n  /* Make everything look a little nicer in webkit */\n  -webkit-font-smoothing: antialiased;\n}\n  /* -webkit-text-size-adjust: auto\n  // -moz-text-size-adjust: auto\n  // -ms-text-size-adjust: auto\n  // -o-text-size-adjust: auto\n  // text-size-adjust: auto */\n\n/* Copy & Lists */\np {\n  line-height: calc(1.5 * 1rem);\n  margin-top: calc(1.5 * 1rem);\n  margin-bottom: 0;\n}\nul, ol {\n  margin-top: calc(1.5 * 1rem);\n  margin-bottom: calc(1.5 * 1rem);\n}\nul li, ol li {\n  line-height: calc(1.5 * 1rem);\n}\nul ul, ul ol, ol ul, ol ol {\n  margin-top: 0;\n  margin-bottom: 0;\n}\n\nblockquote {\n  line-height: calc(1.5 * 1rem);\n  margin-top: calc(1.5 * 1rem);\n  margin-bottom: calc(1.5 * 1rem);\n}\n/* Headings */\nh1, h2, h3, h4, h5, h6 {\n  /* Change heading typefaces here */\n  font-family: 'Bariol', 'Archivo Narrow', 'Source Sans Pro', 'Alegreya', 'Playfair Display', 'Fira Sans', 'Vollkorn', 'ProximaNova-Semibold', 'Helvetica', 'sans-serif';\n  font-weight: bold;\n  font-style: normal;\n  margin-top: calc(1.5 * 1rem);\n  margin-bottom: 0;\n  line-height: calc(1.5 * 1rem);\n}\nh1 {\n  font-size: calc(2.20 * 1.414 * 1rem);\n  font-weight: 700;\n  line-height: calc(2.35 * 1.5 * 1rem);\n  margin-top: calc(0.15 * 1.5 * 1rem);\n}\n\n@media only screen and (min-width: 680px){\n  h1{\n    font-size: calc(3 * 1.414 * 1rem);\n    line-height: calc(3 * 1.5 * 1rem);\n    //margin-top: calc(2 * calc(1.5 * 1rem));\n  }\n}\n\n\nh2 {\n  font-size: calc(2 * 1.414 * 1rem);\n  line-height: calc(2 * 1.5 * 1rem);\n  margin-top: calc(2 * 1.5 * 1rem);\n}\n\nh3 {\n  font-size: calc(1 * 1.414 * 1rem);\n}\nh4 {\n  font-size: calc(1.414 / 2 * 1rem);\n}\nh5 {\n  font-size: calc(1.414 / 3 * 1rem);\n}\nh6 {\n  font-size: calc(1.414 / 4 * 1rem);\n}\n\n/* Tables */\ntable {\n  margin-top: calc(1.5 * 1rem);\n  border-spacing: 0px;\n  border-collapse: collapse;\n}\ntable td, table th {\n  padding: 0;\n  line-height: calc(1.5 * 22 - 0px);\n}\n/* Code blocks */\ncode {\n  /* Forces text to constrain to the line-height. Not ideal, but works. */\n  vertical-align: bottom;\n}\n/* Leading paragraph text */\n.lead {\n  font-size: calc(1.414 * 1rem);\n}\n\n/* Hug a the block above you */\n.hug {\n  margin-top: 0;\n}\n\n\n.Mmmystery {\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-flex-flow: row wrap;\n      -ms-flex-flow: row wrap;\n          flex-flow: row wrap;\n  max-width: 100%;\n  margin-left: auto;\n  margin-right: auto;\n  display: flex;\n  -webkit-flex-flow: column nowrap;\n      -ms-flex-flow: column nowrap;\n          flex-flow: column nowrap;\n}\n\n.Image-section {\n  -webkit-box-flex: 0;\n  -webkit-flex: 0 0 auto;\n      -ms-flex: 0 0 auto;\n          flex: 0 0 auto;\n  width: calc(99.99% * 1/1 - (30px - 30px * 1/1));\n}\n\n.Image-section:nth-child(n){\n  margin-right: 30px;\n}\n\n.Image-section:last-child{\n  margin-right: 0;\n}\n\n.Image-section:nth-child(1n){\n  margin-right: 0;\n}\n\n.Content-section {\n  -webkit-box-flex: 0;\n  -webkit-flex: 0 0 auto;\n      -ms-flex: 0 0 auto;\n          flex: 0 0 auto;\n  width: calc(99.99% * 1/1 - (30px - 30px * 1/1));\n}\n\n.Content-section:nth-child(n){\n  margin-right: 30px;\n}\n\n.Content-section:last-child{\n  margin-right: 0;\n}\n\n.Content-section:nth-child(1n){\n  margin-right: 0;\n}\n\n.featureImg {\n  width: 100%;\n  height: auto;\n  border-top-left-radius: 75px;\n}\n\n\n.Content-title h5 {\n  font-family: 'Bariol','Abril Fatface','Playfair Display','Fira Sans','Vollkorn','ProximaNova-Semibold','Helvetica','sans-serif';\n  font-size: calc(1 * 1.414 * 1rem);\n  line-height: calc(1.4 * 1.5 * 1rem);\n}\n\n\n.Content-title p {\n  margin-top: calc(1.5 * 1rem / 6);\n}\n\n.Content-summary {\n  margin-top: calc(1.5 * 1rem / 6);\n  position: relative;\n}\n\n.Content-summary:before {\n  content: '';\n  display: block;\n  position: absolute;\n  z-index: -1;\n  top: 0;\n  height: 79px;\n  width: 70px;\n  background-color: #FDEEBD;\n  -webkit-mask-image: url('data:image/svg+xml;charset=utf-8,<svg width=\"79\" height=\"71\" viewBox=\"0 0 79 71\" xmlns=\"http://www.w3.org/2000/svg\"><title>Quotation</title><path d=\"M57.52 35.775c0 2.56 1.51 3.922 4.534 4.082l4.774.24c3.182.16 6.006 1.68 8.473 4.562 2.467 2.88 3.7 6.162 3.7 9.843 0 4.482-1.59 8.244-4.773 11.285-3.183 3.04-7.16 4.562-11.934 4.562-5.57 0-10.143-2.2-13.724-6.603-3.58-4.402-5.37-10.044-5.37-16.927 0-12.806 5.01-25.93 15.036-39.377C61.896 2.48 65.078 0 67.782 0c3.024 0 4.535 1.6 4.535 4.802 0 1.28-.875 3.04-2.625 5.282-4.296 5.443-7.876 11.925-10.74 19.45-.955 2.56-1.432 4.64-1.432 6.24zm-43.438 0c0 2.56 1.51 3.922 4.534 4.082l4.774.24c3.34.16 6.245 1.68 8.71 4.562 2.467 2.88 3.7 6.162 3.7 9.843 0 4.482-1.59 8.244-4.773 11.285-3.182 3.04-7.16 4.562-11.933 4.562-5.57 0-10.144-2.2-13.724-6.603C1.79 59.345 0 53.703 0 46.82 0 34.014 5.012 20.89 15.036 7.443 18.696 2.48 21.878 0 24.583 0c3.023 0 4.535 1.6 4.535 4.802 0 1.28-.875 3.04-2.626 5.282-3.182 4.002-6.046 8.644-8.592 13.926-2.546 5.283-3.818 9.204-3.818 11.765z\" fill=\"#FDEEBD\" fill-rule=\"evenodd\"/></svg>');\n  mask-image: url('data:image/svg+xml;charset=utf-8,<svg width=\"79\" height=\"71\" viewBox=\"0 0 79 71\" xmlns=\"http://www.w3.org/2000/svg\"><title>Quotation</title><path d=\"M57.52 35.775c0 2.56 1.51 3.922 4.534 4.082l4.774.24c3.182.16 6.006 1.68 8.473 4.562 2.467 2.88 3.7 6.162 3.7 9.843 0 4.482-1.59 8.244-4.773 11.285-3.183 3.04-7.16 4.562-11.934 4.562-5.57 0-10.143-2.2-13.724-6.603-3.58-4.402-5.37-10.044-5.37-16.927 0-12.806 5.01-25.93 15.036-39.377C61.896 2.48 65.078 0 67.782 0c3.024 0 4.535 1.6 4.535 4.802 0 1.28-.875 3.04-2.625 5.282-4.296 5.443-7.876 11.925-10.74 19.45-.955 2.56-1.432 4.64-1.432 6.24zm-43.438 0c0 2.56 1.51 3.922 4.534 4.082l4.774.24c3.34.16 6.245 1.68 8.71 4.562 2.467 2.88 3.7 6.162 3.7 9.843 0 4.482-1.59 8.244-4.773 11.285-3.182 3.04-7.16 4.562-11.933 4.562-5.57 0-10.144-2.2-13.724-6.603C1.79 59.345 0 53.703 0 46.82 0 34.014 5.012 20.89 15.036 7.443 18.696 2.48 21.878 0 24.583 0c3.023 0 4.535 1.6 4.535 4.802 0 1.28-.875 3.04-2.626 5.282-3.182 4.002-6.046 8.644-8.592 13.926-2.546 5.283-3.818 9.204-3.818 11.765z\" fill=\"#FDEEBD\" fill-rule=\"evenodd\"/></svg>');\n}\n\n@media only screen and (max-width: 679px){\n  .Mmmystery{\n    padding: 0 15px;\n  }\n  .Content-title{\n    margin-bottom: 25px;\n  }\n  .Content-title h5{\n    margin-top: calc(.75 * 1rem);\n    color: #FFBF00;\n    font-weight: normal;\n  }\n  .Content-title p{\n    margin-top: 0;\n    font-size: 20px;\n    color: #5B6675;\n    font-weight: 400;\n  }\n  .Content-summary{\n    font-size: calc(.8 * 1.414 * 1rem);\n    line-height: calc(1.15 * 1.5 * 1rem);\n    font-weight: 300;\n  }\n}\n\n@media only screen and (min-width: 680px){\n  .Mmmystery{\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-flex-flow: row wrap;\n        -ms-flex-flow: row wrap;\n            flex-flow: row wrap;\n    max-width: 100%;\n    margin-left: auto;\n    margin-right: auto;\n    display: flex;\n    -webkit-flex-flow: row wrap;\n        -ms-flex-flow: row wrap;\n            flex-flow: row wrap;\n  }\n  .Image-section{\n    -webkit-box-flex: 0;\n    -webkit-flex: 0 0 auto;\n        -ms-flex: 0 0 auto;\n            flex: 0 0 auto;\n    width: calc(99.99% * 3/5 - (30px - 30px * 3/5));\n  }\n  .Image-section:nth-child(n){\n    margin-right: 30px;\n  }\n  .Image-section:last-child{\n    margin-right: 0;\n  }\n  .Image-section:nth-child(5n){\n    margin-right: 0;\n  }\n  .Content-section{\n    -webkit-box-flex: 0;\n    -webkit-flex: 0 0 auto;\n        -ms-flex: 0 0 auto;\n            flex: 0 0 auto;\n    width: calc(99.99% * 2/5 - (30px - 30px * 2/5));\n  }\n  .Content-section:nth-child(n){\n    margin-right: 30px;\n  }\n  .Content-section:last-child{\n    margin-right: 0;\n  }\n  .Content-section:nth-child(5n){\n    margin-right: 0;\n  }\n  .featureImg{\n    border-top-right-radius: 75px;\n  }\n  .Content-title{\n    -webkit-box-flex: 0;\n    -webkit-flex: 0 0 auto;\n        -ms-flex: 0 0 auto;\n            flex: 0 0 auto;\n    width: calc(99.99% * 1/2 - (30px - 30px * 1/2));\n  }\n  .Content-title:nth-child(n){\n    margin-right: 30px;\n  }\n  .Content-title:last-child{\n    margin-right: 0;\n  }\n  .Content-title:nth-child(2n){\n    margin-right: 0;\n  }\n  .Content-title h5{\n    font-weight: 700;\n  }\n  .Content-title p{\n    -webkit-box-flex: 0;\n    -webkit-flex: 0 0 auto;\n        -ms-flex: 0 0 auto;\n            flex: 0 0 auto;\n    width: calc(99.99% * 9/10 - (30px - 30px * 9/10));\n    font-size: 22px;\n    color: #394453;\n    line-height: calc(1.10 * 1.5 * 1rem);\n    font-weight: 300;\n    font-family: 'ProximaNova-Light','Open Sans','Helvetica','sans-serif';\n  }\n  .Content-title p:nth-child(n){\n    margin-right: 30px;\n  }\n  .Content-title p:last-child{\n    margin-right: 0;\n  }\n  .Content-title p:nth-child(10n){\n    margin-right: 0;\n  }\n  .Content-Summary{}\n}\n\n\n\n", ""]);
